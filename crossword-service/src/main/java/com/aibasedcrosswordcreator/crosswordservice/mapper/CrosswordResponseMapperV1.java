...
public class CrosswordResponseMapperV1 implements StandardCrosswordResponseMapper {
    static StandardCrosswordResponse getCrosswordResponse(StandardCrossword crossword, String[][] body) {
